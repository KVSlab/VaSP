...
def set_problem_parameters(default_variables, **namespace):
    ...
    default_variables.update(dict(
        ...
        folder="artery_coarse_rescaled",
        mesh_file="artery_coarse_rescaled",
        ...
        P_mean=11200,# in Pascals, # Problem specific
...
def create_bcs(t, v_, DVP, mesh, boundaries, domains, mu_f,
    ...
    inlet = make_womersley_bcs_from_coefficients(Cn, T_Cycle, mesh, mu_f, tmp_area, tmp_center, tmp_radius, tmp_normal, DVP.sub(1).sub(0).ufl_element())
