...
if os.path.exists(formatted_data_path):
    ...
    if dvp != "wss":
         ...
         #postprocessing_common_h5py.create_domain_specific_viz(formatted_data_folder, visualization_sd1_folder, mesh_path_sd1, time_between_output_files*2,dvp)
    if dvp == "v" or dvp == "d":
        postprocessing_common_h5py.create_hi_pass_viz(formatted_data_folder, visualization_hi_pass_folder, mesh_path,time_between_output_files,dvp,lowcut,100000)
        postprocessing_common_h5py.create_hi_pass_viz(formatted_data_folder, visualization_hi_pass_folder, mesh_path,time_between_output_files,dvp,lowcut,100000,True)
